...
ColVis.prototype = {
	...
	"_fnConstruct": function ( init )
	{
		...
		this.dom.button = $('<button />', {
		    'class': "ColVis_Button ColVis_MasterButton btn btn-default dropdown-toggle " + this.s.buttonClass,
		    'data-toggle': "dropdown"
		})
            .append('<i class="glyphicon glyphicon-th icon-th"></i>')
	...
	"_fnCollectionShow": function ()
	{
		...
		var iDivY = parseInt(oPos.top + 10 + $(this.dom.button).outerHeight(), 10);
		...
		if ( ! this.s.bCssPosition )
		{
			...
			nHidden.style.left = "auto";
			nHidden.style.float = "right";
			nHidden.style.right = 41 + "px";
		}
