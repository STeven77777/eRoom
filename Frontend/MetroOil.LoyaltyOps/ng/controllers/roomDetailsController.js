(function () {
    ...
    var newRoomDetailController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http, commonService) {
        // local declare
        var vm = this;
        var ApiUrl = $rootScope.getRootUrl() + '/RoomDetails';

        var Initial = function () {
            $.blockUI();
            var params = $.param({ Prefix: 'RoomDetailInfoNew' });
            $http({
                method: 'GET',
        ...
        $scope.SaveInfo = function () {
            ...
            $http({
                method: 'POST',
                data: $scope._Object,
                url: ApiUrl + '/AddRoomDetail'
            }).then(
                function successCallback(response) {
                    if (response.data) {
                        if (response.data.ResponseCode === 0 && response.data.Result) {
                            response.data.ResponseDesc += '. Click on <a href="' + $rootScope.getRootUrl() + "/RoomDetails#/" + response.data.Result.RoomDetailIDHash + '/Info">' + response.data.Result.RoomDetailIDHash + '</a> to view detail.'
        ...
        $scope.BackToList = function () {
            window.location.href = $rootScope.getRootUrl() + "/RoomDetails#/";
        };
    }

    var roomDetailsController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http, commonService) {
        // local declare
        var vm = this;
        var ApiUrl = $rootScope.getRootUrl() + '/RoomDetails';
        ...
        var Initial = function () {
            $.blockUI();
            var params = $.param({ Prefix: 'RoomDetailSearch' });
            $http({
                method: 'GET',
                url: ApiUrl + '/FillData?' + params
            })
        ...
        $scope.OnSearch = function () {
            ...
            var uri = ApiUrl + '/RoomDetailSearch?' + ($scope._Object ? $.param($scope._Object) : '');
        ...
        $scope.$on("gotoDetail", function (event, aData) {
            window.location.href = $rootScope.getRootUrl() + "/RoomDetails#/" + aData[8] + "/Info";
        });
    }

    var roomDetailInfoController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http, commonService) {
        // local declare
        ...
        var Initial = function () {
            $.blockUI();
            var params = $.param({ Prefix: 'RoomDetailInfo', RoomDetailIDHash: $rootScope.obj.busnLocationNoHash });
            $http({
                method: 'GET',
                url: ApiUrl + '/FillData?' + params
            })
        ...
        $scope.ShowHistory = function () {
            ...
            var opts = angular.extend($scope.stsHisLst, {
                serverSide: true,
                ajax: ApiUrl + '/AccountLogList?' + $.param({ RoomDetailIDHash: $rootScope.obj.busnLocationNoHash }),
                destroy: true
            });
    ...
    var busnLotAddrController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        $.blockUI();
        var params = $.param({ Prefix: 'BusnLotAddrs', RoomDetailIDHash: $rootScope.obj.busnLocationNoHash });
        $http({
            method: 'GET',
            url: ApiUrl + '/FillData?' + params
        })
        ...
        $scope.$on("gotoDetail", function (event, aData) {
            window.location.href = $rootScope.getRootUrl() + "/RoomDetails#/" + $rootScope.obj.busnLocationNoHash + "/Address/" + aData[12];
        });

        $scope.gotoAddressNew = function () {
            window.location.href = $rootScope.getRootUrl() + "/RoomDetails#/" + $rootScope.obj.busnLocationNoHash + "/Address/New";
        };
    };
    ...
    var busnLotAddrNewController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        var Initial = function () {
            $.blockUI();
            var params = $.param({ Prefix: 'BusnLotAddrNew', RoomDetailIDHash: $rootScope.obj.busnLocationNoHash });
            $http({
                method: 'GET',
                url: ApiUrl + '/FillData?' + params
            })
        ...
        $scope.backToList = function () {
            window.location.href = $rootScope.getRootUrl() + "/RoomDetails#/" + $rootScope.obj.busnLocationNoHash + "/Address";
        };
    ...
    var busnLotAddrDetailController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        $.blockUI();
        var params = $.param({ Prefix: 'BusnLotAddrD', BusnLocationAddressId: $rootScope.obj.busnLocationAddressId, RoomDetailIDHash: $rootScope.obj.busnLocationNoHash });
        $http({
            method: 'GET',
            url: ApiUrl + '/FillData?' + params
        })
    ...
    var busnLotContController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        $.blockUI();
        var params = $.param({ Prefix: 'BusnLotConts', RoomDetailIDHash: $rootScope.obj.busnLocationNoHash });
        $http({
            method: 'GET',
            url: ApiUrl + '/FillData?' + params
        })
        ...
        $scope.$on("gotoDetail", function (event, aData) {
            window.location.href = $rootScope.getRootUrl() + "/RoomDetails#/" + $rootScope.obj.busnLocationNoHash + "/Contact/" + aData[7];
        });

        $scope.gotoNew = function () {
            window.location.href = $rootScope.getRootUrl() + "/RoomDetails#/" + $rootScope.obj.busnLocationNoHash + "/Contact/New";
        };
    };
    ...
    var busnLotContNewController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        var Initial = function () {
            $.blockUI();
            var params = $.param({ Prefix: 'BusnLotContNew', RoomDetailIDHash: $rootScope.obj.busnLocationNoHash });
            $http({
                method: 'GET',
                url: ApiUrl + '/FillData?' + params
            })
        ...
        $scope.backToList = function () {
            window.location.href = $rootScope.getRootUrl() + "/RoomDetails#/" + $rootScope.obj.busnLocationNoHash + "/Contact";
        };
    ...
    var busnLotContDetailController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        $.blockUI();
        var params = $.param({ Prefix: 'BusnLotContD', BusnLocationContactId: $rootScope.obj.busnLocationContactId, RoomDetailIDHash: $rootScope.obj.busnLocationNoHash });
        $http({
            method: 'GET',
            url: ApiUrl + '/FillData?' + params
        })
    ...
    var busnLotTerminalsController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        $.blockUI();
        var params = $.param({ Prefix: 'BusnLotTerminals', RoomDetailIDHash: $rootScope.obj.busnLocationNoHash });
        $http({
            method: 'GET',
            url: ApiUrl + '/FillData?' + params
        })
            ...
            .then(function () {
                if ($scope._GeneralInfo.EntityId) {
                    $scope.dtOptions = {
                        ...
                        "ordering": true,
                        id: 'allAddresses',
                        ajax: ApiUrl + '/TerminalList?' + $.param({ RoomDetailIDHash: $scope._GeneralInfo.RoomDetailIDHash }),
                        edit: {
                            level: 'scope',
                            func: 'gotoDetail'
                        },
        ...
        $scope.$on("gotoDetail", function (event, aData) {
            window.location.href = $rootScope.getRootUrl() + "/RoomDetails#/" + $rootScope.obj.busnLocationNoHash + "/Terminals/" + aData[7];
        });

        $scope.gotoNew = function () {
            window.location.href = $rootScope.getRootUrl() + "/RoomDetails#/" + $rootScope.obj.busnLocationNoHash + "/Terminals/New";
        };
    };
    ...
    var busnLotTerminalNewController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        var Initial = function () {
            $.blockUI();
            var params = $.param({ Prefix: 'BusnLotTerminalNew', RoomDetailIDHash: $rootScope.obj.busnLocationNoHash });
            $http({
                method: 'GET',
                url: ApiUrl + '/FillData?' + params
            })
        ...
        $scope.backToList = function () {
            window.location.href = $rootScope.getRootUrl() + "/RoomDetails#/" + $rootScope.obj.busnLocationNoHash + "/Terminals";
        };
    ...
    var busnLotTerminalInfoController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        var Initial = function () {
            $.blockUI();
            var params = $.param({ Prefix: 'BusnLotTerminalInfo', TerminalIds: $rootScope.obj.terminalIds, RoomDetailIDHash: $rootScope.obj.busnLocationNoHash });
            $http({
                method: 'GET',
                url: ApiUrl + '/FillData?' + params
            })
    ...
    var busnLotTxnPointsController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        var Initial = function () {
            ...
            var params = $.param({ Prefix: 'BusnLotTxnPoints', RoomDetailIDHash: $rootScope.obj.busnLocationNoHash });
            $http({
                method: 'GET',
                url: ApiUrl + '/FillData?' + params
            })
    ...
    var busnLotCrdRangeAccptController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        var Initial = function () {
            ...
            var params = $.param({ Prefix: 'BusnLotCrdRangeAccpt', RoomDetailIDHash: $rootScope.obj.busnLocationNoHash });
            $http({
                method: 'GET',
                url: ApiUrl + '/FillData?' + params
            })
        ...
        $scope.AddCardRange = function () {
            ...
            $http({
                method: 'POST',
                data: {
                    RoomDetailIDHash: $scope._GeneralInfo.RoomDetailIDHash,
    ...
    newRoomDetailController.$inject = injectParams;
    roomDetailsController.$inject = injectParams;
    roomDetailInfoController.$inject = injectParams;
    ...
    angular.module('loyaltyApp').controller('newRoomDetailController', newRoomDetailController);
    angular.module('loyaltyApp').controller('roomDetailsController', roomDetailsController);
    angular.module('loyaltyApp').controller('roomDetailInfoController', roomDetailInfoController);
