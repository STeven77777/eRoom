(function () {
    ...
    var newPeopleController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http, commonService) {
        // local declare
        var vm = this;
        var ApiUrl = $rootScope.getRootUrl() + '/Peoples';

        var Initial = function () {
            $.blockUI();
            var params = $.param({ Prefix: 'PeopleInfoNew' });
            $http({
                method: 'GET',
        ...
        $scope.SaveInfo = function () {
            ...
            $http({
                method: 'POST',
                data: $scope._Object,
                url: ApiUrl + '/AddPeople'
            }).then(
                function successCallback(response) {
                    if (response.data) {
                        if (response.data.ResponseCode === 0 && response.data.Result) {
                            response.data.ResponseDesc += '. Click on <a href="' + $rootScope.getRootUrl() + "/Peoples#/" + response.data.Result.PeopleIDHash + '/Info">' + response.data.Result.PeopleIDHash + '</a> to view detail.'
        ...
        $scope.BackToList = function () {
            window.location.href = $rootScope.getRootUrl() + "/Peoples#/";
        };
    }

    var peoplesController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http, commonService) {
        // local declare
        var vm = this;
        var ApiUrl = $rootScope.getRootUrl() + '/Peoples';
        ...
        var Initial = function () {
            $.blockUI();
            var params = $.param({ Prefix: 'PeopleSearch' });
            $http({
                method: 'GET',
                url: ApiUrl + '/FillData?' + params
            })
        ...
        $scope.OnSearch = function () {
            ...
            var uri = ApiUrl + '/PeopleSearch?' + ($scope._Object ? $.param($scope._Object) : '');
        ...
        $scope.$on("gotoDetail", function (event, aData) {
            window.location.href = $rootScope.getRootUrl() + "/Peoples#/" + aData[8] + "/Info";
        });
    }

    var peopleInfoController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http, commonService) {
        // local declare
        ...
        var Initial = function () {
            $.blockUI();
            var params = $.param({ Prefix: 'PeopleInfo', PeopleIDHash: $rootScope.obj.busnLocationNoHash });
            $http({
                method: 'GET',
                url: ApiUrl + '/FillData?' + params
            })
        ...
        $scope.ShowHistory = function () {
            ...
            var opts = angular.extend($scope.stsHisLst, {
                serverSide: true,
                ajax: ApiUrl + '/AccountLogList?' + $.param({ PeopleIDHash: $rootScope.obj.busnLocationNoHash }),
                destroy: true
            });
    ...
    var busnLotAddrController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        $.blockUI();
        var params = $.param({ Prefix: 'BusnLotAddrs', PeopleIDHash: $rootScope.obj.busnLocationNoHash });
        $http({
            method: 'GET',
            url: ApiUrl + '/FillData?' + params
        })
        ...
        $scope.$on("gotoDetail", function (event, aData) {
            window.location.href = $rootScope.getRootUrl() + "/Peoples#/" + $rootScope.obj.busnLocationNoHash + "/Address/" + aData[12];
        });

        $scope.gotoAddressNew = function () {
            window.location.href = $rootScope.getRootUrl() + "/Peoples#/" + $rootScope.obj.busnLocationNoHash + "/Address/New";
        };
    };
    ...
    var busnLotAddrNewController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        var Initial = function () {
            $.blockUI();
            var params = $.param({ Prefix: 'BusnLotAddrNew', PeopleIDHash: $rootScope.obj.busnLocationNoHash });
            $http({
                method: 'GET',
                url: ApiUrl + '/FillData?' + params
            })
        ...
        $scope.backToList = function () {
            window.location.href = $rootScope.getRootUrl() + "/Peoples#/" + $rootScope.obj.busnLocationNoHash + "/Address";
        };
    ...
    var busnLotAddrDetailController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        $.blockUI();
        var params = $.param({ Prefix: 'BusnLotAddrD', BusnLocationAddressId: $rootScope.obj.busnLocationAddressId, PeopleIDHash: $rootScope.obj.busnLocationNoHash });
        $http({
            method: 'GET',
            url: ApiUrl + '/FillData?' + params
        })
    ...
    var busnLotContController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        $.blockUI();
        var params = $.param({ Prefix: 'BusnLotConts', PeopleIDHash: $rootScope.obj.busnLocationNoHash });
        $http({
            method: 'GET',
            url: ApiUrl + '/FillData?' + params
        })
        ...
        $scope.$on("gotoDetail", function (event, aData) {
            window.location.href = $rootScope.getRootUrl() + "/Peoples#/" + $rootScope.obj.busnLocationNoHash + "/Contact/" + aData[7];
        });

        $scope.gotoNew = function () {
            window.location.href = $rootScope.getRootUrl() + "/Peoples#/" + $rootScope.obj.busnLocationNoHash + "/Contact/New";
        };
    };
    ...
    var busnLotContNewController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        var Initial = function () {
            $.blockUI();
            var params = $.param({ Prefix: 'BusnLotContNew', PeopleIDHash: $rootScope.obj.busnLocationNoHash });
            $http({
                method: 'GET',
                url: ApiUrl + '/FillData?' + params
            })
        ...
        $scope.backToList = function () {
            window.location.href = $rootScope.getRootUrl() + "/Peoples#/" + $rootScope.obj.busnLocationNoHash + "/Contact";
        };
    ...
    var busnLotContDetailController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        $.blockUI();
        var params = $.param({ Prefix: 'BusnLotContD', BusnLocationContactId: $rootScope.obj.busnLocationContactId, PeopleIDHash: $rootScope.obj.busnLocationNoHash });
        $http({
            method: 'GET',
            url: ApiUrl + '/FillData?' + params
        })
    ...
    var busnLotTerminalsController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        $.blockUI();
        var params = $.param({ Prefix: 'BusnLotTerminals', PeopleIDHash: $rootScope.obj.busnLocationNoHash });
        $http({
            method: 'GET',
            url: ApiUrl + '/FillData?' + params
        })
            ...
            .then(function () {
                if ($scope._GeneralInfo.EntityId) {
                    $scope.dtOptions = {
                        ...
                        "ordering": true,
                        id: 'allAddresses',
                        ajax: ApiUrl + '/TerminalList?' + $.param({ PeopleIDHash: $scope._GeneralInfo.PeopleIDHash }),
                        edit: {
                            level: 'scope',
                            func: 'gotoDetail'
                        },
        ...
        $scope.$on("gotoDetail", function (event, aData) {
            window.location.href = $rootScope.getRootUrl() + "/Peoples#/" + $rootScope.obj.busnLocationNoHash + "/Terminals/" + aData[7];
        });

        $scope.gotoNew = function () {
            window.location.href = $rootScope.getRootUrl() + "/Peoples#/" + $rootScope.obj.busnLocationNoHash + "/Terminals/New";
        };
    };
    ...
    var busnLotTerminalNewController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        var Initial = function () {
            $.blockUI();
            var params = $.param({ Prefix: 'BusnLotTerminalNew', PeopleIDHash: $rootScope.obj.busnLocationNoHash });
            $http({
                method: 'GET',
                url: ApiUrl + '/FillData?' + params
            })
        ...
        $scope.backToList = function () {
            window.location.href = $rootScope.getRootUrl() + "/Peoples#/" + $rootScope.obj.busnLocationNoHash + "/Terminals";
        };
    ...
    var busnLotTerminalInfoController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        var Initial = function () {
            $.blockUI();
            var params = $.param({ Prefix: 'BusnLotTerminalInfo', TerminalIds: $rootScope.obj.terminalIds, PeopleIDHash: $rootScope.obj.busnLocationNoHash });
            $http({
                method: 'GET',
                url: ApiUrl + '/FillData?' + params
            })
    ...
    var busnLotTxnPointsController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        var Initial = function () {
            ...
            var params = $.param({ Prefix: 'BusnLotTxnPoints', PeopleIDHash: $rootScope.obj.busnLocationNoHash });
            $http({
                method: 'GET',
                url: ApiUrl + '/FillData?' + params
            })
    ...
    var busnLotCrdRangeAccptController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        var Initial = function () {
            ...
            var params = $.param({ Prefix: 'BusnLotCrdRangeAccpt', PeopleIDHash: $rootScope.obj.busnLocationNoHash });
            $http({
                method: 'GET',
                url: ApiUrl + '/FillData?' + params
            })
        ...
        $scope.AddCardRange = function () {
            ...
            $http({
                method: 'POST',
                data: {
                    PeopleIDHash: $scope._GeneralInfo.PeopleIDHash,
    ...
    newPeopleController.$inject = injectParams;
    peoplesController.$inject = injectParams;
    peopleInfoController.$inject = injectParams;
    ...
    angular.module('loyaltyApp').controller('newPeopleController', newPeopleController);
    angular.module('loyaltyApp').controller('peoplesController', peoplesController);
    angular.module('loyaltyApp').controller('peopleInfoController', peopleInfoController);
