(function () {
    ...
    var newRoomTypeController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http, commonService) {
        // local declare
        var vm = this;
        var ApiUrl = $rootScope.getRootUrl() + '/RoomTypes';

        var Initial = function () {
            $.blockUI();
            var params = $.param({ Prefix: 'RoomTypeInfoNew' });
            $http({
                method: 'GET',
        ...
        $scope.SaveInfo = function () {
            ...
            $http({
                method: 'POST',
                data: $scope._Object,
                url: ApiUrl + '/AddRoomType'
            }).then(
                function successCallback(response) {
                    if (response.data) {
                        if (response.data.ResponseCode === 0 && response.data.Result) {
                            response.data.ResponseDesc += '. Click on <a href="' + $rootScope.getRootUrl() + "/RoomTypes#/" + response.data.Result.RoomTypeIDHash + '/Info">' + response.data.Result.RoomTypeIDHash + '</a> to view detail.'
        ...
        $scope.BackToList = function () {
            window.location.href = $rootScope.getRootUrl() + "/RoomTypes#/";
        };
    }

    var roomTypesController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http, commonService) {
        // local declare
        var vm = this;
        var ApiUrl = $rootScope.getRootUrl() + '/RoomTypes';
        ...
        var Initial = function () {
            $.blockUI();
            var params = $.param({ Prefix: 'RoomTypeSearch' });
            $http({
                method: 'GET',
                url: ApiUrl + '/FillData?' + params
            })
        ...
        $scope.OnSearch = function () {
            ...
            var uri = ApiUrl + '/RoomTypeSearch?' + ($scope._Object ? $.param($scope._Object) : '');
        ...
        $scope.$on("gotoDetail", function (event, aData) {
            window.location.href = $rootScope.getRootUrl() + "/RoomTypes#/" + aData[8] + "/Info";
        });
    }

    var roomTypeInfoController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http, commonService) {
        // local declare
        ...
        var Initial = function () {
            $.blockUI();
            var params = $.param({ Prefix: 'RoomTypeInfo', RoomTypeIDHash: $rootScope.obj.busnLocationNoHash });
            $http({
                method: 'GET',
                url: ApiUrl + '/FillData?' + params
            })
        ...
        $scope.ShowHistory = function () {
            ...
            var opts = angular.extend($scope.stsHisLst, {
                serverSide: true,
                ajax: ApiUrl + '/AccountLogList?' + $.param({ RoomTypeIDHash: $rootScope.obj.busnLocationNoHash }),
                destroy: true
            });
    ...
    var busnLotAddrController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        $.blockUI();
        var params = $.param({ Prefix: 'BusnLotAddrs', RoomTypeIDHash: $rootScope.obj.busnLocationNoHash });
        $http({
            method: 'GET',
            url: ApiUrl + '/FillData?' + params
        })
        ...
        $scope.$on("gotoDetail", function (event, aData) {
            window.location.href = $rootScope.getRootUrl() + "/RoomTypes#/" + $rootScope.obj.busnLocationNoHash + "/Address/" + aData[12];
        });

        $scope.gotoAddressNew = function () {
            window.location.href = $rootScope.getRootUrl() + "/RoomTypes#/" + $rootScope.obj.busnLocationNoHash + "/Address/New";
        };
    };
    ...
    var busnLotAddrNewController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        var Initial = function () {
            $.blockUI();
            var params = $.param({ Prefix: 'BusnLotAddrNew', RoomTypeIDHash: $rootScope.obj.busnLocationNoHash });
            $http({
                method: 'GET',
                url: ApiUrl + '/FillData?' + params
            })
        ...
        $scope.backToList = function () {
            window.location.href = $rootScope.getRootUrl() + "/RoomTypes#/" + $rootScope.obj.busnLocationNoHash + "/Address";
        };
    ...
    var busnLotAddrDetailController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        $.blockUI();
        var params = $.param({ Prefix: 'BusnLotAddrD', BusnLocationAddressId: $rootScope.obj.busnLocationAddressId, RoomTypeIDHash: $rootScope.obj.busnLocationNoHash });
        $http({
            method: 'GET',
            url: ApiUrl + '/FillData?' + params
        })
    ...
    var busnLotContController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        $.blockUI();
        var params = $.param({ Prefix: 'BusnLotConts', RoomTypeIDHash: $rootScope.obj.busnLocationNoHash });
        $http({
            method: 'GET',
            url: ApiUrl + '/FillData?' + params
        })
        ...
        $scope.$on("gotoDetail", function (event, aData) {
            window.location.href = $rootScope.getRootUrl() + "/RoomTypes#/" + $rootScope.obj.busnLocationNoHash + "/Contact/" + aData[7];
        });

        $scope.gotoNew = function () {
            window.location.href = $rootScope.getRootUrl() + "/RoomTypes#/" + $rootScope.obj.busnLocationNoHash + "/Contact/New";
        };
    };
    ...
    var busnLotContNewController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        var Initial = function () {
            $.blockUI();
            var params = $.param({ Prefix: 'BusnLotContNew', RoomTypeIDHash: $rootScope.obj.busnLocationNoHash });
            $http({
                method: 'GET',
                url: ApiUrl + '/FillData?' + params
            })
        ...
        $scope.backToList = function () {
            window.location.href = $rootScope.getRootUrl() + "/RoomTypes#/" + $rootScope.obj.busnLocationNoHash + "/Contact";
        };
    ...
    var busnLotContDetailController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        $.blockUI();
        var params = $.param({ Prefix: 'BusnLotContD', BusnLocationContactId: $rootScope.obj.busnLocationContactId, RoomTypeIDHash: $rootScope.obj.busnLocationNoHash });
        $http({
            method: 'GET',
            url: ApiUrl + '/FillData?' + params
        })
    ...
    var busnLotTerminalsController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        $.blockUI();
        var params = $.param({ Prefix: 'BusnLotTerminals', RoomTypeIDHash: $rootScope.obj.busnLocationNoHash });
        $http({
            method: 'GET',
            url: ApiUrl + '/FillData?' + params
        })
            ...
            .then(function () {
                if ($scope._GeneralInfo.EntityId) {
                    $scope.dtOptions = {
                        ...
                        "ordering": true,
                        id: 'allAddresses',
                        ajax: ApiUrl + '/TerminalList?' + $.param({ RoomTypeIDHash: $scope._GeneralInfo.RoomTypeIDHash }),
                        edit: {
                            level: 'scope',
                            func: 'gotoDetail'
                        },
        ...
        $scope.$on("gotoDetail", function (event, aData) {
            window.location.href = $rootScope.getRootUrl() + "/RoomTypes#/" + $rootScope.obj.busnLocationNoHash + "/Terminals/" + aData[7];
        });

        $scope.gotoNew = function () {
            window.location.href = $rootScope.getRootUrl() + "/RoomTypes#/" + $rootScope.obj.busnLocationNoHash + "/Terminals/New";
        };
    };
    ...
    var busnLotTerminalNewController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        var Initial = function () {
            $.blockUI();
            var params = $.param({ Prefix: 'BusnLotTerminalNew', RoomTypeIDHash: $rootScope.obj.busnLocationNoHash });
            $http({
                method: 'GET',
                url: ApiUrl + '/FillData?' + params
            })
        ...
        $scope.backToList = function () {
            window.location.href = $rootScope.getRootUrl() + "/RoomTypes#/" + $rootScope.obj.busnLocationNoHash + "/Terminals";
        };
    ...
    var busnLotTerminalInfoController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        var Initial = function () {
            $.blockUI();
            var params = $.param({ Prefix: 'BusnLotTerminalInfo', TerminalIds: $rootScope.obj.terminalIds, RoomTypeIDHash: $rootScope.obj.busnLocationNoHash });
            $http({
                method: 'GET',
                url: ApiUrl + '/FillData?' + params
            })
    ...
    var busnLotTxnPointsController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        var Initial = function () {
            ...
            var params = $.param({ Prefix: 'BusnLotTxnPoints', RoomTypeIDHash: $rootScope.obj.busnLocationNoHash });
            $http({
                method: 'GET',
                url: ApiUrl + '/FillData?' + params
            })
    ...
    var busnLotCrdRangeAccptController = function ($scope, $rootScope, $location, $window, $timeout, ngDialog, Utils, $http) {
        ...
        var Initial = function () {
            ...
            var params = $.param({ Prefix: 'BusnLotCrdRangeAccpt', RoomTypeIDHash: $rootScope.obj.busnLocationNoHash });
            $http({
                method: 'GET',
                url: ApiUrl + '/FillData?' + params
            })
        ...
        $scope.AddCardRange = function () {
            ...
            $http({
                method: 'POST',
                data: {
                    RoomTypeIDHash: $scope._GeneralInfo.RoomTypeIDHash,
    ...
    newRoomTypeController.$inject = injectParams;
    roomTypesController.$inject = injectParams;
    roomTypeInfoController.$inject = injectParams;
    ...
    angular.module('loyaltyApp').controller('newRoomTypeController', newRoomTypeController);
    angular.module('loyaltyApp').controller('roomTypesController', roomTypesController);
    angular.module('loyaltyApp').controller('roomTypeInfoController', roomTypeInfoController);
