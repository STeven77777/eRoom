(function () {
    var app = angular.module('loyaltyApp',
        ['ngRoute', 'ngAnimate', 'ui.bootstrap', 'App.Utils', 'ui.router', 'ui.select', 'ngSanitize', 'ngDialog', 'datePicker', 'dynform']);
    ...
    app.config(['$stateProvider', '$urlRouterProvider', '$locationProvider', 'ngDialogProvider', function ($stateProvider, $urlRouterProvider, $locationProvider, ngDialogProvider) {
        ...
        $stateProvider
            .state('RptViewer', {
                url: "/ReportViewer",
                templateUrl: rooturl + "/Reports/Tmpl?Prefix=RptViewer&type=Index",
                data: { pageTitle: 'Report Viewer' },
                controller: "rptViewerController",
                pageKey: 'RptViewer'
            })
        ;
