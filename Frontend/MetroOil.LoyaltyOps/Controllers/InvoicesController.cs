...
namespace MetroOil.LoyaltyOps.Controllers
{
    ...
    public class InvoicesController : Controller
    {
        ...
        public ActionResult Tmpl(string Prefix)
        {
            ...
            {
                case "InvoiceSearch":
                    return PartialView("List", new InvoiceModel());
                case "InvoiceInfoNew":
                    return PartialView("New", new InvoiceModel());
                case "InvoiceInfo":
                    return PartialView("Info", new InvoiceModel());
                default:
                    return PartialView();
            }
        }
        ...
        public async Task<JsonResult> FillData(string Prefix, string InvoiceIDHash, string InvoiceAddressId, string InvoiceContactId, string TerminalIds)
        {
            switch (Prefix)
            {
                case "InvoiceSearch":
                    {
                        var _infoObj = new InvoiceModel();

                        var _States = await Common.GetState(null);
                        var _infoSelects = new InvoiceModel()
                        {
                            //States = _States,
                            //DBAStates = _States
                        };

                        return Json(new FormResponseModel<InvoiceModel, InvoiceModel>()
                        {
                ...
                case "InvoiceInfoNew":
                    {
                        var _newObj = new InvoiceModel()
                        {

                        };
                        var _newSelects = new InvoiceModel()
                        {
                ...
                case "InvoiceInfo":
                    {
                        var _infoObj = await ApiClient.GetJsonAsync<APIResponseModel<InvoiceModel>>
                            ("invoices/" + Helper.Decrypt(InvoiceIDHash));

                        if (_infoObj != null && _infoObj.Result != null)
                        {
                            _infoObj.Result.InvoiceIDHash = InvoiceIDHash;
                        }
                ...
                case "InvoiceAddrs":
                    {
                        //var _info = await ApiClient.GetJsonAsync<APIResponseModel<InvoiceModel>>
                        //    ("merchant/BusinessLocation?" + Helper.GetQueryString(new { Invoice = Helper.Decrypt(InvoiceIDHash) }));
                        //var _info = await ApiClient.GetJsonAsync<APIResponseModel<InvoiceModel>>("Invoices/" + Helper.GetQueryString(new { InvoiceNumber = Helper.Decrypt(InvoiceIDHash) }));
                        var _info = await ApiClient.GetJsonAsync<APIResponseModel<InvoiceModel>>("Invoices/" + Helper.Decrypt(InvoiceIDHash));
                        //var _info = await ApiClient.GetJsonAsync<APIResponseListModel<InvoiceModel>>("Invoices/GetList");
                        //var _info = await ApiClient.GetArrayJsonAsync<APIResponseModel<List<InvoiceModel>>>("Invoices/GetList");

                        if (_info != null && _info.Result != null)
                        {
                            // _info.Result.InvoiceID = Helper.Encrypt(_info.Result.InvoiceID);
                            return Json(new FormResponseModel<InvoiceModel, InvoiceModel>()
                            {
                ...
                case "InvoiceAddrNew":
                    {
                        ...
                        {
                            //_info.Result.InvoiceIDHash = Helper.Encrypt(_info.Result.InvoiceID);
                            ...
                            return Json(new FormResponseModel<AddressModel, InvoiceModel>()
                            {
                                ResponseCode = Enums.RESPONSE_CODE_VALID,
                                ResponseDesc = "",
                                Model = _newAddress,
                ...
                //        if (_info != null && _info.Result != null && _info.ResponseCode == Enums.RESPONSE_CODE_VALID)
                //        {
                //            //_info.Result.InvoiceIDHash = Helper.Encrypt(_info.Result.AcctNo);

                //            var addrObj = await ApiClient.GetJsonAsync<APIResponseModel<AddressModel>>
                //                ("common/Address?" + Helper.GetQueryString(new { Ids = InvoiceAddressId }));
                ...
                //        if (_info != null && _info.Result != null)
                //        {
                //            _info.Result.InvoiceIDHash = Helper.Encrypt(_info.Result.Invoice);
                //            return Json(new FormResponseModel<InvoiceModel, InvoiceModel>()
                //            {
                //                ResponseCode = _info.ResponseCode,
                //                ResponseDesc = _info.ResponseDesc,
                ...
                //            return Json(new FormResponseModel<ContactModel, InvoiceModel>()
                //            {
                //                ResponseCode = Enums.RESPONSE_CODE_VALID,
                //                ResponseDesc = "",
                //                Model = _Obj,
                ...
                //                ("common/ContactById?" + Helper.GetQueryString(new { Ids = InvoiceContactId }));
                ...
                //            {
                //                InvoiceIDHash = _info.Result.InvoiceIDHash
                //            };
                ...
                //            return Json(new FormResponseModel<TerminalModel, InvoiceModel>()
                //            {
                //                ResponseCode = Enums.RESPONSE_CODE_VALID,
                //                ResponseDesc = "",
                //                Model = _Obj,
                ...
                //            if (_Obj.ResponseCode == Enums.RESPONSE_CODE_VALID)
                //            {
                //                if (_Obj.Result != null && _info.Result != null && _Obj.Result.Invoice == _info.Result.Invoice) // valid merchant and address
                //                {
                ...
                //            {
                //                //InvoiceNos = await Common.GetBusinessLocations(),
                //            };

                //            return Json(new FormResponseModel<TxnPointSearchModel, InvoiceModel>()
                //            {
                //                ResponseCode = Enums.RESPONSE_CODE_VALID,
                //                Model = _Obj,
                //                Selects = _Selects,
                ...
                //case "InvoiceCrdRangeAccpt":
                //    {
                //        var InvoiceNo = Helper.Decrypt(InvoiceIDHash);
                //        var _info = await ApiClient.GetJsonAsync<APIResponseModel<InvoiceModel>>
                //            ("merchant/BusinessLocation?" + Helper.GetQueryString(new { Invoice = InvoiceNo }));
                ...
                //                ("merchant/CardRangeList?InvoiceNo=" + InvoiceNo + "&" + Helper.GetQueryString(_params));
                ...
                //            return Json(new FormResponseModel<CardRangeAcceptanceListModel, InvoiceModel>()
                //            {
                //                ResponseCode = Enums.RESPONSE_CODE_VALID,
                //                Model = _Obj,
                //                Selects = _Selects,
        ...
        public async Task<ActionResult> InvoiceSearch(jQueryDataTableParamModel Params, InvoiceModel model)
        {
            var displyColumns = new string[] { "InvoiceID", "InvoiceMonth", "RoomID", "InvoiceTotal", "InvoicePaid", "InvoiceRemain", "CreateDate", "Description" };
            ...
            var response = await ApiClient.GetJsonAsync<APIResponseListModel<InvoiceModel>>
                ("invoices/invoicelist?" + Helper.GetQueryString(Params) + "&" + Helper.GetQueryString(model));

            if (response == null || response.ResponseCode != 0 || response.Result == null || response.Result.RecordList == null) // empty data/ error
            {
                response.Result.RecordList = new List<InvoiceModel>();
            }
            ...
            return Json(new
            {
                ...
                aaData = response.Result.RecordList.Select((x, index) => new object[] { Params.iDisplayStart + index + 1, x.InvoiceID, x.InvoiceMonth, x.RoomID, x.InvoiceTotal, 
                    x.InvoicePaid, x.InvoiceRemain, x.CreateDate != null ? x.CreateDate.Value.ToString(Enums.DATE_FORMAT) : string.Empty, x.Description, Helpers.Helper.Encrypt(x.InvoiceID) })
            }, JsonRequestBehavior.AllowGet);
        }
        #endregion
        ...
        [HttpPost]
        public async Task<JsonResult> AddInvoice(InvoiceModel model)
        {
            //    model.AllCardRange = model.AllCardRange ?? false;
            //    model.AllTxnCodeMapping = model.AllTxnCodeMapping ?? false;

            // Call API to update 
            var rp = await ApiClient.PostJsonAsync<APIResponseModel<InvoiceModel>>
                ("Invoices", JsonConvert.SerializeObject(model));

            if (rp.ResponseCode == Enums.RESPONSE_CODE_VALID && rp.Result != null)
            {
                rp.Result.InvoiceIDHash = Helper.Encrypt(rp.Result.InvoiceID);
            }
        ...
        [HttpPatch]
        public async Task<JsonResult> UpdateInvoice(InvoiceModel model)
        {
            //model.InvoiceID = Helper.Decrypt(model.InvoiceID);
            //var result = await ApiClient.PatchJsonAsync<APIResponseModel<InvoiceModel>>
        ...
        /// <returns></returns>
        [HttpGet]
        public async Task<ActionResult> AccountLogList(jQueryDataTableParamModel Params, string InvoiceIDHash)
        {
            var response = await ApiClient.GetJsonAsync<APIResponseListModel<LogChangeModel>>
                ("merchant/BusinessLocationLogList?Invoice=" + Helper.Decrypt(InvoiceIDHash) + "&" + Helper.GetQueryString(Params));
        ...
        /// <returns></returns>
        [HttpPatch]
        public async Task<JsonResult> InvoiceStatus(Models.Merchants.Account.MerchantAcctStatusModel model)
        {
        ...
        public async Task<ActionResult> TerminalList(jQueryDataTableParamModel Params, string InvoiceIDHash)
        {
            ...
            var response = await ApiClient.GetJsonAsync<APIResponseListModel<TerminalModel>>
                ("merchant/TerminalInventoryList?" + Helper.GetQueryString(Params) + "&InvoiceNo=" + Helper.Decrypt(InvoiceIDHash));
        ...
        //{
        //    // Call API to update 
        //    model.Invoice = Helper.Decrypt(model.InvoiceIDHash);
        //    //model.InvoiceNo = model.Invoice;// will be removed soon
        ...
        public async Task<ActionResult> GetTxnByBusinessLocation(jQueryDataTableParamModel Params, TxnPointSearchModel txnSearch)
        {
            if (txnSearch != null)
            {
                //txnSearch.Invoice = Helper.Decrypt(txnSearch.InvoiceIDHash);
            }
        ...
        //{
        //    model.InvoiceNo = Helper.Decrypt(model.InvoiceIDHash);
        //    // Call API to update 
