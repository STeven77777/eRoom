...
namespace MetroOil.LoyaltyOps.Controllers
{
    ...
    public class RoomDetailsController : Controller
    {
        ...
        public ActionResult Tmpl(string Prefix)
        {
            switch (Prefix)
            {
                case "RoomDetailSearch":
                    return PartialView("List", new RoomDetailModel());
                case "RoomDetailInfoNew":
                    return PartialView("New", new RoomDetailModel());
                case "RoomDetailInfo":
                    return PartialView("Info", new RoomDetailModel());
                default:
                    return PartialView();
            }
        }
        ...
        public async Task<JsonResult> FillData(string Prefix, string RoomDetailIDHash, string RoomDetailAddressId, string RoomDetailContactId, string TerminalIds)
        {
            switch (Prefix)
            {
                case "RoomDetailSearch":
                    {
                        var _infoObj = new RoomDetailModel();

                        var _States = await Common.GetState(null);
                        var _infoSelects = new RoomDetailModel()
                        {
                            //States = _States,
                            //DBAStates = _States
                        };

                        return Json(new FormResponseModel<RoomDetailModel, RoomDetailModel>()
                        {
                ...
                case "RoomDetailInfoNew":
                    {
                        var _newObj = new RoomDetailModel()
                        {

                        };
                        var _newSelects = new RoomDetailModel()
                        {
                ...
                case "RoomDetailInfo":
                    {
                        var _infoObj = await ApiClient.GetJsonAsync<APIResponseModel<RoomDetailModel>>
                            ("roomDetails/" + Helper.Decrypt(RoomDetailIDHash));

                        if (_infoObj != null && _infoObj.Result != null)
                        {
                            _infoObj.Result.RoomDetailIDHash = RoomDetailIDHash;
                        }
                ...
                case "RoomDetailAddrs":
                    {
                        //var _info = await ApiClient.GetJsonAsync<APIResponseModel<RoomDetailModel>>
                        //    ("merchant/BusinessLocation?" + Helper.GetQueryString(new { RoomDetail = Helper.Decrypt(RoomDetailIDHash) }));
                        //var _info = await ApiClient.GetJsonAsync<APIResponseModel<RoomDetailModel>>("RoomDetails/" + Helper.GetQueryString(new { RoomDetailNumber = Helper.Decrypt(RoomDetailIDHash) }));
                        var _info = await ApiClient.GetJsonAsync<APIResponseModel<RoomDetailModel>>("RoomDetails/" + Helper.Decrypt(RoomDetailIDHash));
                        //var _info = await ApiClient.GetJsonAsync<APIResponseListModel<RoomDetailModel>>("RoomDetails/GetList");
                        //var _info = await ApiClient.GetArrayJsonAsync<APIResponseModel<List<RoomDetailModel>>>("RoomDetails/GetList");

                        if (_info != null && _info.Result != null)
                        {
                            // _info.Result.RoomDetailID = Helper.Encrypt(_info.Result.RoomDetailID);
                            return Json(new FormResponseModel<RoomDetailModel, RoomDetailModel>()
                            {
                ...
                case "RoomDetailAddrNew":
                    {
                        ...
                        {
                            //_info.Result.RoomDetailIDHash = Helper.Encrypt(_info.Result.RoomDetailID);
                            ...
                            return Json(new FormResponseModel<AddressModel, RoomDetailModel>()
                            {
                                ResponseCode = Enums.RESPONSE_CODE_VALID,
                                ResponseDesc = "",
                                Model = _newAddress,
                ...
                //        if (_info != null && _info.Result != null && _info.ResponseCode == Enums.RESPONSE_CODE_VALID)
                //        {
                //            //_info.Result.RoomDetailIDHash = Helper.Encrypt(_info.Result.AcctNo);

                //            var addrObj = await ApiClient.GetJsonAsync<APIResponseModel<AddressModel>>
                //                ("common/Address?" + Helper.GetQueryString(new { Ids = RoomDetailAddressId }));
                ...
                //        if (_info != null && _info.Result != null)
                //        {
                //            _info.Result.RoomDetailIDHash = Helper.Encrypt(_info.Result.RoomDetail);
                //            return Json(new FormResponseModel<RoomDetailModel, RoomDetailModel>()
                //            {
                //                ResponseCode = _info.ResponseCode,
                //                ResponseDesc = _info.ResponseDesc,
                ...
                //            return Json(new FormResponseModel<ContactModel, RoomDetailModel>()
                //            {
                //                ResponseCode = Enums.RESPONSE_CODE_VALID,
                //                ResponseDesc = "",
                //                Model = _Obj,
                ...
                //                ("common/ContactById?" + Helper.GetQueryString(new { Ids = RoomDetailContactId }));
                ...
                //            {
                //                RoomDetailIDHash = _info.Result.RoomDetailIDHash
                //            };
                ...
                //            return Json(new FormResponseModel<TerminalModel, RoomDetailModel>()
                //            {
                //                ResponseCode = Enums.RESPONSE_CODE_VALID,
                //                ResponseDesc = "",
                //                Model = _Obj,
                ...
                //            if (_Obj.ResponseCode == Enums.RESPONSE_CODE_VALID)
                //            {
                //                if (_Obj.Result != null && _info.Result != null && _Obj.Result.RoomDetail == _info.Result.RoomDetail) // valid merchant and address
                //                {
                ...
                //            {
                //                //RoomDetailNos = await Common.GetBusinessLocations(),
                //            };

                //            return Json(new FormResponseModel<TxnPointSearchModel, RoomDetailModel>()
                //            {
                //                ResponseCode = Enums.RESPONSE_CODE_VALID,
                //                Model = _Obj,
                //                Selects = _Selects,
                ...
                //case "RoomDetailCrdRangeAccpt":
                //    {
                //        var RoomDetailNo = Helper.Decrypt(RoomDetailIDHash);
                //        var _info = await ApiClient.GetJsonAsync<APIResponseModel<RoomDetailModel>>
                //            ("merchant/BusinessLocation?" + Helper.GetQueryString(new { RoomDetail = RoomDetailNo }));
                ...
                //                ("merchant/CardRangeList?RoomDetailNo=" + RoomDetailNo + "&" + Helper.GetQueryString(_params));
                ...
                //            return Json(new FormResponseModel<CardRangeAcceptanceListModel, RoomDetailModel>()
                //            {
                //                ResponseCode = Enums.RESPONSE_CODE_VALID,
                //                Model = _Obj,
                //                Selects = _Selects,
        ...
        public async Task<ActionResult> RoomDetailSearch(jQueryDataTableParamModel Params, RoomDetailModel model)
        {
            var displyColumns = new string[] { "RoomDetailID", "RoomID", "DateIn", "DateOut", "CreateDate", "CreateUser", "Description" };
            ...
            var response = await ApiClient.GetJsonAsync<APIResponseListModel<RoomDetailModel>>
                ("roomDetails/roomDetaillist?" + Helper.GetQueryString(Params) + "&" + Helper.GetQueryString(model));

            if (response == null || response.ResponseCode != 0 || response.Result == null || response.Result.RecordList == null) // empty data/ error
            {
                response.Result.RecordList = new List<RoomDetailModel>();
            }
            ...
            return Json(new
            {
                ...
                aaData = response.Result.RecordList.Select((x, index) => new object[] { Params.iDisplayStart + index + 1, x.RoomDetailID, x.RoomID, 
                    ...
                    x.CreateUser,
                    x.Description, Helpers.Helper.Encrypt(x.RoomDetailID) })
            }, JsonRequestBehavior.AllowGet);
        }
        #endregion
        ...
        [HttpPost]
        public async Task<JsonResult> AddRoomDetail(RoomDetailModel model)
        {
            //    model.AllCardRange = model.AllCardRange ?? false;
            //    model.AllTxnCodeMapping = model.AllTxnCodeMapping ?? false;

            // Call API to update 
            var rp = await ApiClient.PostJsonAsync<APIResponseModel<RoomDetailModel>>
                ("RoomDetails", JsonConvert.SerializeObject(model));

            if (rp.ResponseCode == Enums.RESPONSE_CODE_VALID && rp.Result != null)
            {
                rp.Result.RoomDetailIDHash = Helper.Encrypt(rp.Result.RoomDetailID);
            }
        ...
        [HttpPatch]
        public async Task<JsonResult> UpdateRoomDetail(RoomDetailModel model)
        {
            //model.RoomDetailID = Helper.Decrypt(model.RoomDetailID);
            //var result = await ApiClient.PatchJsonAsync<APIResponseModel<RoomDetailModel>>
        ...
        /// <returns></returns>
        [HttpGet]
        public async Task<ActionResult> AccountLogList(jQueryDataTableParamModel Params, string RoomDetailIDHash)
        {
            var response = await ApiClient.GetJsonAsync<APIResponseListModel<LogChangeModel>>
                ("merchant/BusinessLocationLogList?RoomDetail=" + Helper.Decrypt(RoomDetailIDHash) + "&" + Helper.GetQueryString(Params));
        ...
        /// <returns></returns>
        [HttpPatch]
        public async Task<JsonResult> RoomDetailStatus(Models.Merchants.Account.MerchantAcctStatusModel model)
        {
        ...
        public async Task<ActionResult> TerminalList(jQueryDataTableParamModel Params, string RoomDetailIDHash)
        {
            ...
            var response = await ApiClient.GetJsonAsync<APIResponseListModel<TerminalModel>>
                ("merchant/TerminalInventoryList?" + Helper.GetQueryString(Params) + "&RoomDetailNo=" + Helper.Decrypt(RoomDetailIDHash));
        ...
        //{
        //    // Call API to update 
        //    model.RoomDetail = Helper.Decrypt(model.RoomDetailIDHash);
        //    //model.RoomDetailNo = model.RoomDetail;// will be removed soon
        ...
        public async Task<ActionResult> GetTxnByBusinessLocation(jQueryDataTableParamModel Params, TxnPointSearchModel txnSearch)
        {
            if (txnSearch != null)
            {
                //txnSearch.RoomDetail = Helper.Decrypt(txnSearch.RoomDetailIDHash);
            }
        ...
        //{
        //    model.RoomDetailNo = Helper.Decrypt(model.RoomDetailIDHash);
        //    // Call API to update 
