...
namespace MetroOil.LoyaltyOps.Controllers
{
    ...
    public class ServicesController : Controller
    {
        ...
        public ActionResult Tmpl(string Prefix)
        {
            ...
            {
                case "ServiceSearch":
                    return PartialView("List", new ServiceModel());
                case "ServiceInfoNew":
                    return PartialView("New", new ServiceModel());
                case "ServiceInfo":
                    return PartialView("Info", new ServiceModel());
                default:
                    return PartialView();
            }
        }
        ...
        public async Task<JsonResult> FillData(string Prefix, string ServiceIDHash, string ServiceAddressId, string ServiceContactId, string TerminalIds)
        {
            switch (Prefix)
            {
                case "ServiceSearch":
                    {
                        var _infoObj = new ServiceModel();

                        var _States = await Common.GetState(null);
                        var _infoSelects = new ServiceModel()
                        {
                            //States = _States,
                            //DBAStates = _States
                        };

                        return Json(new FormResponseModel<ServiceModel, ServiceModel>()
                        {
                ...
                case "ServiceInfoNew":
                    {
                        var _newObj = new ServiceModel()
                        {

                        };
                        var _newSelects = new ServiceModel()
                        {
                ...
                case "ServiceInfo":
                    {
                        var _infoObj = await ApiClient.GetJsonAsync<APIResponseModel<ServiceModel>>
                            ("services/" + Helper.Decrypt(ServiceIDHash));

                        if (_infoObj != null && _infoObj.Result != null)
                        {
                            _infoObj.Result.ServiceIDHash = ServiceIDHash;
                        }
                ...
                case "ServiceAddrs":
                    {
                        //var _info = await ApiClient.GetJsonAsync<APIResponseModel<ServiceModel>>
                        //    ("merchant/BusinessLocation?" + Helper.GetQueryString(new { Service = Helper.Decrypt(ServiceIDHash) }));
                        //var _info = await ApiClient.GetJsonAsync<APIResponseModel<ServiceModel>>("Services/" + Helper.GetQueryString(new { ServiceNumber = Helper.Decrypt(ServiceIDHash) }));
                        var _info = await ApiClient.GetJsonAsync<APIResponseModel<ServiceModel>>("Services/" + Helper.Decrypt(ServiceIDHash));
                        //var _info = await ApiClient.GetJsonAsync<APIResponseListModel<ServiceModel>>("Services/GetList");
                        //var _info = await ApiClient.GetArrayJsonAsync<APIResponseModel<List<ServiceModel>>>("Services/GetList");

                        if (_info != null && _info.Result != null)
                        {
                            // _info.Result.ServiceID = Helper.Encrypt(_info.Result.ServiceID);
                            return Json(new FormResponseModel<ServiceModel, ServiceModel>()
                            {
                ...
                case "ServiceAddrNew":
                    {
                        ...
                        {
                            //_info.Result.ServiceIDHash = Helper.Encrypt(_info.Result.ServiceID);
                            ...
                            return Json(new FormResponseModel<AddressModel, ServiceModel>()
                            {
                                ResponseCode = Enums.RESPONSE_CODE_VALID,
                                ResponseDesc = "",
                                Model = _newAddress,
                ...
                //        if (_info != null && _info.Result != null && _info.ResponseCode == Enums.RESPONSE_CODE_VALID)
                //        {
                //            //_info.Result.ServiceIDHash = Helper.Encrypt(_info.Result.AcctNo);

                //            var addrObj = await ApiClient.GetJsonAsync<APIResponseModel<AddressModel>>
                //                ("common/Address?" + Helper.GetQueryString(new { Ids = ServiceAddressId }));
                ...
                //        if (_info != null && _info.Result != null)
                //        {
                //            _info.Result.ServiceIDHash = Helper.Encrypt(_info.Result.Service);
                //            return Json(new FormResponseModel<ServiceModel, ServiceModel>()
                //            {
                //                ResponseCode = _info.ResponseCode,
                //                ResponseDesc = _info.ResponseDesc,
                ...
                //            return Json(new FormResponseModel<ContactModel, ServiceModel>()
                //            {
                //                ResponseCode = Enums.RESPONSE_CODE_VALID,
                //                ResponseDesc = "",
                //                Model = _Obj,
                ...
                //                ("common/ContactById?" + Helper.GetQueryString(new { Ids = ServiceContactId }));
                ...
                //            {
                //                ServiceIDHash = _info.Result.ServiceIDHash
                //            };
                ...
                //            return Json(new FormResponseModel<TerminalModel, ServiceModel>()
                //            {
                //                ResponseCode = Enums.RESPONSE_CODE_VALID,
                //                ResponseDesc = "",
                //                Model = _Obj,
                ...
                //            if (_Obj.ResponseCode == Enums.RESPONSE_CODE_VALID)
                //            {
                //                if (_Obj.Result != null && _info.Result != null && _Obj.Result.Service == _info.Result.Service) // valid merchant and address
                //                {
                ...
                //            {
                //                //ServiceNos = await Common.GetBusinessLocations(),
                //            };

                //            return Json(new FormResponseModel<TxnPointSearchModel, ServiceModel>()
                //            {
                //                ResponseCode = Enums.RESPONSE_CODE_VALID,
                //                Model = _Obj,
                //                Selects = _Selects,
                ...
                //case "ServiceCrdRangeAccpt":
                //    {
                //        var ServiceNo = Helper.Decrypt(ServiceIDHash);
                //        var _info = await ApiClient.GetJsonAsync<APIResponseModel<ServiceModel>>
                //            ("merchant/BusinessLocation?" + Helper.GetQueryString(new { Service = ServiceNo }));
                ...
                //                ("merchant/CardRangeList?ServiceNo=" + ServiceNo + "&" + Helper.GetQueryString(_params));
                ...
                //            return Json(new FormResponseModel<CardRangeAcceptanceListModel, ServiceModel>()
                //            {
                //                ResponseCode = Enums.RESPONSE_CODE_VALID,
                //                Model = _Obj,
                //                Selects = _Selects,
        ...
        public async Task<ActionResult> ServiceSearch(jQueryDataTableParamModel Params, ServiceModel model)
        {
            var displyColumns = new string[] { "ServiceID", "ServiceName", "ServicePrice", "IsDefault", "CreateDate", "CreateUser", "UpdateDate", "UpdateUser", "Description" };
            ...
            var response = await ApiClient.GetJsonAsync<APIResponseListModel<ServiceModel>>
                ("services/servicelist?" + Helper.GetQueryString(Params) + "&" + Helper.GetQueryString(model));

            if (response == null || response.ResponseCode != 0 || response.Result == null || response.Result.RecordList == null) // empty data/ error
            {
                response.Result.RecordList = new List<ServiceModel>();
            }
            ...
            return Json(new
            {
                ...
                aaData = response.Result.RecordList.Select((x, index) => new object[] { Params.iDisplayStart + index + 1, x.ServiceID, x.ServiceName, x.ServicePrice, x.IsDefault,
                    ...
                    x.Description, Helpers.Helper.Encrypt(x.ServiceID.ToString()) })
            }, JsonRequestBehavior.AllowGet);
        }
        #endregion
        ...
        [HttpPost]
        public async Task<JsonResult> AddService(ServiceModel model)
        {
            //    model.AllCardRange = model.AllCardRange ?? false;
            //    model.AllTxnCodeMapping = model.AllTxnCodeMapping ?? false;

            // Call API to update 
            var rp = await ApiClient.PostJsonAsync<APIResponseModel<ServiceModel>>
                ("Services", JsonConvert.SerializeObject(model));

            if (rp.ResponseCode == Enums.RESPONSE_CODE_VALID && rp.Result != null)
            {
                rp.Result.ServiceIDHash = Helper.Encrypt(rp.Result.ServiceID);
            }
        ...
        [HttpPatch]
        public async Task<JsonResult> UpdateService(ServiceModel model)
        {
            //model.ServiceID = Helper.Decrypt(model.ServiceID);
            //var result = await ApiClient.PatchJsonAsync<APIResponseModel<ServiceModel>>
        ...
        /// <returns></returns>
        [HttpGet]
        public async Task<ActionResult> AccountLogList(jQueryDataTableParamModel Params, string ServiceIDHash)
        {
            var response = await ApiClient.GetJsonAsync<APIResponseListModel<LogChangeModel>>
                ("merchant/BusinessLocationLogList?Service=" + Helper.Decrypt(ServiceIDHash) + "&" + Helper.GetQueryString(Params));
        ...
        /// <returns></returns>
        [HttpPatch]
        public async Task<JsonResult> ServiceStatus(Models.Merchants.Account.MerchantAcctStatusModel model)
        {
        ...
        public async Task<ActionResult> TerminalList(jQueryDataTableParamModel Params, string ServiceIDHash)
        {
            ...
            var response = await ApiClient.GetJsonAsync<APIResponseListModel<TerminalModel>>
                ("merchant/TerminalInventoryList?" + Helper.GetQueryString(Params) + "&ServiceNo=" + Helper.Decrypt(ServiceIDHash));
        ...
        //{
        //    // Call API to update 
        //    model.Service = Helper.Decrypt(model.ServiceIDHash);
        //    //model.ServiceNo = model.Service;// will be removed soon
        ...
        public async Task<ActionResult> GetTxnByBusinessLocation(jQueryDataTableParamModel Params, TxnPointSearchModel txnSearch)
        {
            if (txnSearch != null)
            {
                //txnSearch.Service = Helper.Decrypt(txnSearch.ServiceIDHash);
            }
        ...
        //{
        //    model.ServiceNo = Helper.Decrypt(model.ServiceIDHash);
        //    // Call API to update 
