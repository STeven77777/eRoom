...
namespace MetroOil.LoyaltyOps.Controllers
{
    ...
    public class BusnLocationsController : Controller
    {
        // GET: Cards
        ...
        public ActionResult Tmpl(string Prefix)
        {
            ...
            {
                case "BusnLotSearch":
                    return PartialView("Partials/List", new BusnLocationSearchModel());
                case "BusnLotNew":
                    return PartialView("Partials/New", new RoomModel());
                case "BusnLotInfo":
                    return PartialView("Partials/Profile/Info", new RoomModel());

                case "BusnLotAddrs":
                    return PartialView("Partials/Room/RoomList");
                case "BusnLotAddrNew":
                    return PartialView("Partials/Profile/Address/AddressNew", new AddressModel());
                case "BusnLotAddrD":
                    return PartialView("Partials/Profile/Address/AddressDetail", new AddressModel());

                case "BusnLotConts":
                    return PartialView("Partials/Profile/Contact/Contact");
                case "BusnLotContNew":
                    return PartialView("Partials/Profile/Contact/ContactNew", new ContactModel());
                case "BusnLotContD":
                    return PartialView("Partials/Profile/Contact/ContactDetail", new ContactModel());

                case "BusnLotTerminals":
                    return PartialView("Partials/Profile/Terminals/List");
                case "BusnLotTerminalNew":
                    return PartialView("Partials/Profile/Terminals/New", new TerminalModel());
                case "BusnLotTerminalInfo":
                    return PartialView("Partials/Profile/Terminals/Info", new TerminalModel());

                case "BusnLotTxnPoints":
                    return PartialView("Partials/Transactions/Points", new TxnPointSearchModel());

                case "BusnLotCrdRangeAccpt":
                    return PartialView("Partials/Control/CardRangeAcceptance");
                default:
                    return PartialView();
            }
        }
        ...
        public async Task<JsonResult> FillData(string Prefix, string BusnLocationNoHash, string BusnLocationAddressId, string BusnLocationContactId, string TerminalIds)
        {
            switch (Prefix)
            {
                case "BusnLotSearch":
                    {
                        var _infoObj = new BusnLocationSearchModel();

                        var _States = await Common.GetState(null);
                        var _infoSelects = new BusnLocationSearchModel()
                        {
                            States = _States,
                            DBAStates = _States
                        };

                        return Json(new FormResponseModel<BusnLocationSearchModel, BusnLocationSearchModel>()
                        {
                ...
                case "BusnLotNew":
                    {
                        var _newObj = new BusnLocationModel()
                        {
                            
                        };
                        var _newSelects = new BusnLocationModel()
                        {
                ...
                case "BusnLotInfo":
                    {
                        var _infoObj = await ApiClient.GetJsonAsync<APIResponseModel<RoomModel>>
                            ("Rooms/" + Helper.Decrypt(BusnLocationNoHash));

                        if (_infoObj != null && _infoObj.Result != null)
                        {
                            //_infoObj.Result.RoomID = BusnLocationNoHash;
                        }

                        var _infoSelects = new RoomModel()
                        {
                            //AcctNos = await Common.GetMerchants(),
                        ...
                        return Json(new FormResponseModel<RoomModel, RoomModel>()
                        {
                ...
                case "BusnLotAddrs":
                    {
                        //var _info = await ApiClient.GetJsonAsync<APIResponseModel<BusnLocationModel>>
                        //    ("merchant/BusinessLocation?" + Helper.GetQueryString(new { BusnLocation = Helper.Decrypt(BusnLocationNoHash) }));
                        //var _info = await ApiClient.GetJsonAsync<APIResponseModel<RoomModel>>("Rooms/" + Helper.GetQueryString(new { RoomNumber = Helper.Decrypt(BusnLocationNoHash) }));
                        var _info = await ApiClient.GetJsonAsync<APIResponseModel<RoomModel>>("Rooms/" + Helper.Decrypt(BusnLocationNoHash));
                        //var _info = await ApiClient.GetJsonAsync<APIResponseListModel<RoomModel>>("Rooms/GetList");
                        //var _info = await ApiClient.GetArrayJsonAsync<APIResponseModel<List<RoomModel>>>("Rooms/GetList");

                        if (_info != null && _info.Result != null)
                        {
                            // _info.Result.RoomID = Helper.Encrypt(_info.Result.RoomID);
                            return Json(new FormResponseModel<RoomModel, RoomModel>()
                            {
                        ...
                        {
                            return Json(new FormResponseModel<BusnLocationModel, BusnLocationModel>()
                            {
                ...
                case "BusnLotAddrNew":
                    {
                        ...
                        {
                            _info.Result.BusnLocationNoHash = Helper.Encrypt(_info.Result.AcctNo);
                            ...
                            return Json(new FormResponseModel<AddressModel, BusnLocationModel>()
                            {
                                ResponseCode = Enums.RESPONSE_CODE_VALID,
                                ResponseDesc = "",
                                Model = _newAddress,
                ...
                case "BusnLotAddrD":
                    {
                        ...
                        if (_info != null && _info.Result != null && _info.ResponseCode == Enums.RESPONSE_CODE_VALID)
                        {
                            ...
                            var addrObj = await ApiClient.GetJsonAsync<APIResponseModel<AddressModel>>
                                ("common/Address?" + Helper.GetQueryString(new { Ids = BusnLocationAddressId }));
                ...
                case "BusnLotConts":
                    {
                        ...
                        if (_info != null && _info.Result != null)
                        {
                            _info.Result.BusnLocationNoHash = Helper.Encrypt(_info.Result.BusnLocation);
                            return Json(new FormResponseModel<BusnLocationModel, BusnLocationModel>()
                            {
                                ResponseCode = _info.ResponseCode,
                                ResponseDesc = _info.ResponseDesc,
                ...
                case "BusnLotContNew":
                    {
                        ...
                        if (_info != null && _info.Result != null && _info.ResponseCode == Enums.RESPONSE_CODE_VALID)
                        {
                            ...
                            return Json(new FormResponseModel<ContactModel, BusnLocationModel>()
                            {
                                ResponseCode = Enums.RESPONSE_CODE_VALID,
                                ResponseDesc = "",
                                Model = _Obj,
                ...
                case "BusnLotContD":
                    {
                        ...
                        if (_info != null && _info.Result != null && _info.ResponseCode == Enums.RESPONSE_CODE_VALID)
                        {
                            ...
                            var _Obj = await ApiClient.GetJsonAsync<APIResponseModel<ContactModel>>
                                ("common/ContactById?" + Helper.GetQueryString(new { Ids = BusnLocationContactId }));
                ...
                case "BusnLotTerminalNew":
                    {
                        ...
                        if (_info != null && _info.Result != null && _info.ResponseCode == Enums.RESPONSE_CODE_VALID)
                        {
                            ...
                            {
                                BusnLocationNoHash = _info.Result.BusnLocationNoHash
                            };
                            ...
                            return Json(new FormResponseModel<TerminalModel, BusnLocationModel>()
                            {
                                ResponseCode = Enums.RESPONSE_CODE_VALID,
                                ResponseDesc = "",
                                Model = _Obj,
                ...
                case "BusnLotTerminalInfo":
                    {
                        ...
                        if (_info != null && _info.Result != null && _info.ResponseCode == Enums.RESPONSE_CODE_VALID)
                        {
                            ...
                            if (_Obj.ResponseCode == Enums.RESPONSE_CODE_VALID)
                            {
                                if (_Obj.Result != null && _info.Result != null && _Obj.Result.BusnLocation == _info.Result.BusnLocation) // valid merchant and address
                                {
                ...
                case "BusnLotTxnPoints":
                    {
                        ...
                        if (_info != null && _info.Result != null && _info.ResponseCode == Enums.RESPONSE_CODE_VALID)
                        {
                            ...
                            return Json(new FormResponseModel<TxnPointSearchModel, BusnLocationModel>()
                            {
                                ResponseCode = Enums.RESPONSE_CODE_VALID,
                                Model = _Obj,
                                Selects = _Selects,
                ...
                case "BusnLotCrdRangeAccpt":
                    {
                        var busnLocationNo = Helper.Decrypt(BusnLocationNoHash);
                        var _info = await ApiClient.GetJsonAsync<APIResponseModel<BusnLocationModel>>
                            ("merchant/BusinessLocation?" + Helper.GetQueryString(new { BusnLocation = busnLocationNo }));
                        ...
                        if (_info != null && _info.Result != null && _info.ResponseCode == Enums.RESPONSE_CODE_VALID)
                        {
                            ...
                            var _cardRangeLst = await ApiClient.GetJsonAsync<APIResponseListModel<CardRangeAcceptanceModel>>
                                ("merchant/CardRangeList?BusnLocationNo=" + busnLocationNo + "&" + Helper.GetQueryString(_params));
                            ...
                            return Json(new FormResponseModel<CardRangeAcceptanceListModel, BusnLocationModel>()
                            {
                                ResponseCode = Enums.RESPONSE_CODE_VALID,
                                Model = _Obj,
                                Selects = _Selects,
        ...
        public async Task<ActionResult> BusnLocationSearch(jQueryDataTableParamModel Params, BusnLocationSearchModel model)
        {
            var displyColumns = new string[] { "BusnLocation", "BusnName", "StateName", "StatusName", "AcctNo", "CreatedDate", "CreatedByName" };
            ...
            var response = await ApiClient.GetJsonAsync<APIResponseListModel<BusnLocationModel>>
                ("merchant/BusinessLocationList?" + Helper.GetQueryString(Params) + "&" + Helper.GetQueryString(model));
            ...
            return Json(new
            {
                ...
                aaData = response.Result.RecordList.Select((x, index) => new object[] { Params.iDisplayStart + index + 1, x.BusnLocation, x.BusnName, x.StateName, x.StatusName, x.AcctNo, x.CreatedDate != null ? x.CreatedDate.Value.ToString(Enums.DATE_FORMAT) : string.Empty, x.CreatedByName, Helper.Encrypt(x.BusnLocation) })
            }, JsonRequestBehavior.AllowGet);
        }
        #endregion
        ...
        [HttpPost]
        public async Task<JsonResult> AddBusnLocation(RoomModel model)
        {
        //    model.AllCardRange = model.AllCardRange ?? false;
        //    model.AllTxnCodeMapping = model.AllTxnCodeMapping ?? false;

            // Call API to update 
            var rp = await ApiClient.PostJsonAsync<APIResponseModel<RoomModel>>
                ("Rooms", JsonConvert.SerializeObject(model));

            if (rp.ResponseCode == Enums.RESPONSE_CODE_VALID && rp.Result != null)
            {
                rp.Result.RoomID = Helper.Encrypt(rp.Result.RoomID);
            }
        ...
        [HttpPatch]
        public async Task<JsonResult> UpdateBusnLocation(RoomModel model)
        {
            //model.RoomID = Helper.Decrypt(model.RoomID);
            //var result = await ApiClient.PatchJsonAsync<APIResponseModel<BusnLocationModel>>
            //  ("merchant/BusinessLocation", JsonConvert.SerializeObject(model));
            var result = await ApiClient.PatchJsonAsync<APIResponseModel<RoomModel>>
                ("Rooms", JsonConvert.SerializeObject(model));
        ...
        /// <returns></returns>
        [HttpGet]
        public async Task<ActionResult> AccountLogList(jQueryDataTableParamModel Params, string BusnLocationNoHash)
        {
            var response = await ApiClient.GetJsonAsync<APIResponseListModel<LogChangeModel>>
                ("merchant/BusinessLocationLogList?BusnLocation=" + Helper.Decrypt(BusnLocationNoHash) + "&" + Helper.GetQueryString(Params));
        ...
        /// <returns></returns>
        [HttpPatch]
        public async Task<JsonResult> BusnLocationStatus(Models.Merchants.Account.MerchantAcctStatusModel model)
        {
        ...
        public async Task<ActionResult> TerminalList(jQueryDataTableParamModel Params, string BusnLocationNoHash)
        {
            ...
            var response = await ApiClient.GetJsonAsync<APIResponseListModel<TerminalModel>>
                ("merchant/TerminalInventoryList?" + Helper.GetQueryString(Params) + "&BusnLocationNo=" + Helper.Decrypt(BusnLocationNoHash));
        ...
        {
            // Call API to update 
            model.BusnLocation = Helper.Decrypt(model.BusnLocationNoHash);
            //model.BusnLocationNo = model.BusnLocation;// will be removed soon
        ...
        public async Task<ActionResult> GetTxnByBusinessLocation(jQueryDataTableParamModel Params, TxnPointSearchModel txnSearch)
        {
            if (txnSearch != null)
            {
                txnSearch.BusnLocation = Helper.Decrypt(txnSearch.BusnLocationNoHash);
            }
        ...
        {
            model.BusnLocationNo = Helper.Decrypt(model.BusnLocationNoHash);
            // Call API to update 
