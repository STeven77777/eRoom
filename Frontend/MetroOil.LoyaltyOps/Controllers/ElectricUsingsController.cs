...
{
    //ElectricUsingsController
    public class ElectricUsingsController : Controller
    {
        // GET: Cards
        ...
        public ActionResult Tmpl(string Prefix)
        {
            switch (Prefix)
            {
                case "ElectricUsingSearch":
                    return PartialView("List", new ElectricUsingModel());
                case "ElectricUsingInfoNew":
                    return PartialView("New", new ElectricUsingModel());
                case "ElectricUsingInfo":
                    return PartialView("Info", new ElectricUsingModel());
                default:
                    return PartialView();
            }
        }
        ...
        public async Task<JsonResult> FillData(string Prefix, string ElectricUsingIDHash, string ElectricUsingAddressId, string ElectricUsingContactId, string TerminalIds)
        {
            switch (Prefix)
            {
                case "ElectricUsingSearch":
                    {
                        var _infoObj = new ElectricUsingModel();

                        var _States = await Common.GetState(null);
                        var _infoSelects = new ElectricUsingModel()
                        {
                            //States = _States,
                            //DBAStates = _States
                        };

                        return Json(new FormResponseModel<ElectricUsingModel, ElectricUsingModel>()
                        {
                ...
                case "ElectricUsingInfoNew":
                    {
                        var _newObj = new ElectricUsingModel()
                        {

                        };
                        var _newSelects = new ElectricUsingModel()
                        {
                ...
                case "ElectricUsingInfo":
                    {
                        var _infoObj = await ApiClient.GetJsonAsync<APIResponseModel<ElectricUsingModel>>
                            ("electricUsings/" + Helper.Decrypt(ElectricUsingIDHash));

                        if (_infoObj != null && _infoObj.Result != null)
                        {
                            _infoObj.Result.ElectricUsingIDHash = ElectricUsingIDHash;
                        }
                ...
                case "ElectricUsingAddrs":
                    {
                        //var _info = await ApiClient.GetJsonAsync<APIResponseModel<ElectricUsingModel>>
                        //    ("merchant/BusinessLocation?" + Helper.GetQueryString(new { ElectricUsing = Helper.Decrypt(ElectricUsingIDHash) }));
                        //var _info = await ApiClient.GetJsonAsync<APIResponseModel<ElectricUsingModel>>("ElectricUsings/" + Helper.GetQueryString(new { ElectricUsingNumber = Helper.Decrypt(ElectricUsingIDHash) }));
                        var _info = await ApiClient.GetJsonAsync<APIResponseModel<ElectricUsingModel>>("ElectricUsings/" + Helper.Decrypt(ElectricUsingIDHash));
                        //var _info = await ApiClient.GetJsonAsync<APIResponseListModel<ElectricUsingModel>>("ElectricUsings/GetList");
                        //var _info = await ApiClient.GetArrayJsonAsync<APIResponseModel<List<ElectricUsingModel>>>("ElectricUsings/GetList");

                        if (_info != null && _info.Result != null)
                        {
                            // _info.Result.ElectricUsingID = Helper.Encrypt(_info.Result.ElectricUsingID);
                            return Json(new FormResponseModel<ElectricUsingModel, ElectricUsingModel>()
                            {
                ...
                case "ElectricUsingAddrNew":
                    {
                        ...
                        {
                            //_info.Result.ElectricUsingIDHash = Helper.Encrypt(_info.Result.ElectricUsingID);
                            ...
                            return Json(new FormResponseModel<AddressModel, ElectricUsingModel>()
                            {
                                ResponseCode = Enums.RESPONSE_CODE_VALID,
                                ResponseDesc = "",
                                Model = _newAddress,
                ...
                //        if (_info != null && _info.Result != null && _info.ResponseCode == Enums.RESPONSE_CODE_VALID)
                //        {
                //            //_info.Result.ElectricUsingIDHash = Helper.Encrypt(_info.Result.AcctNo);

                //            var addrObj = await ApiClient.GetJsonAsync<APIResponseModel<AddressModel>>
                //                ("common/Address?" + Helper.GetQueryString(new { Ids = ElectricUsingAddressId }));
                ...
                //        if (_info != null && _info.Result != null)
                //        {
                //            _info.Result.ElectricUsingIDHash = Helper.Encrypt(_info.Result.ElectricUsing);
                //            return Json(new FormResponseModel<ElectricUsingModel, ElectricUsingModel>()
                //            {
                //                ResponseCode = _info.ResponseCode,
                //                ResponseDesc = _info.ResponseDesc,
                ...
                //            return Json(new FormResponseModel<ContactModel, ElectricUsingModel>()
                //            {
                //                ResponseCode = Enums.RESPONSE_CODE_VALID,
                //                ResponseDesc = "",
                //                Model = _Obj,
                ...
                //                ("common/ContactById?" + Helper.GetQueryString(new { Ids = ElectricUsingContactId }));
                ...
                //            {
                //                ElectricUsingIDHash = _info.Result.ElectricUsingIDHash
                //            };
                ...
                //            return Json(new FormResponseModel<TerminalModel, ElectricUsingModel>()
                //            {
                //                ResponseCode = Enums.RESPONSE_CODE_VALID,
                //                ResponseDesc = "",
                //                Model = _Obj,
                ...
                //        }
                //    }
                //case "ElectricUsingTerminalInfo":
                //    {
                //        var _info = await ApiClient.GetJsonAsync<APIResponseModel<ElectricUsingModel>>
                //            ("merchant/BusinessLocation?" + Helper.GetQueryString(new { ElectricUsing = Helper.Decrypt(ElectricUsingIDHash) }));
                ...
                //            if (_Obj.ResponseCode == Enums.RESPONSE_CODE_VALID)
                //            {
                //                if (_Obj.Result != null && _info.Result != null && _Obj.Result.ElectricUsing == _info.Result.ElectricUsing) // valid merchant and address
                //                {
                ...
                //            {
                //                //ElectricUsingNos = await Common.GetBusinessLocations(),
                //            };

                //            return Json(new FormResponseModel<TxnPointSearchModel, ElectricUsingModel>()
                //            {
                //                ResponseCode = Enums.RESPONSE_CODE_VALID,
                //                Model = _Obj,
                //                Selects = _Selects,
                ...
                //case "ElectricUsingCrdRangeAccpt":
                //    {
                //        var ElectricUsingNo = Helper.Decrypt(ElectricUsingIDHash);
                //        var _info = await ApiClient.GetJsonAsync<APIResponseModel<ElectricUsingModel>>
                //            ("merchant/BusinessLocation?" + Helper.GetQueryString(new { ElectricUsing = ElectricUsingNo }));
                ...
                //                ("merchant/CardRangeList?ElectricUsingNo=" + ElectricUsingNo + "&" + Helper.GetQueryString(_params));
                ...
                //            return Json(new FormResponseModel<CardRangeAcceptanceListModel, ElectricUsingModel>()
                //            {
                //                ResponseCode = Enums.RESPONSE_CODE_VALID,
                //                Model = _Obj,
                //                Selects = _Selects,
        ...
        public async Task<ActionResult> ElectricUsingSearch(jQueryDataTableParamModel Params, ElectricUsingModel model)
        {
            var displyColumns = new string[] {"ElectricUsingID", "RoomID", "ElectricFrom", "ElectricTo", "ElectricUse", "CreateDate", "Description" };
            ...
            var response = await ApiClient.GetJsonAsync<APIResponseListModel<ElectricUsingModel>>
                ("electricUsings/electricUsinglist?" + Helper.GetQueryString(Params) + "&" + Helper.GetQueryString(model));

            if (response == null || response.ResponseCode != 0 || response.Result == null || response.Result.RecordList == null) // empty data/ error
            {
                response.Result.RecordList = new List<ElectricUsingModel>();
            }
            ...
            return Json(new
            {
                ...
                aaData = response.Result.RecordList.Select((x, index) => new object[] { Params.iDisplayStart + index + 1, x.ElectricUsingID, x.RoomID, x.ElectricFrom, 
                    x.ElectricTo, x.ElectricUse, x.CreateDate != null ? x.CreateDate.Value.ToString(Enums.DATE_FORMAT) : string.Empty, x.Description, Helpers.Helper.Encrypt(x.ElectricUsingID) })
            }, JsonRequestBehavior.AllowGet);
        }
        #endregion
        ...
        [HttpPost]
        public async Task<JsonResult> AddElectricUsing(ElectricUsingModel model)
        {
            //    model.AllCardRange = model.AllCardRange ?? false;
            //    model.AllTxnCodeMapping = model.AllTxnCodeMapping ?? false;

            // Call API to update 
            var rp = await ApiClient.PostJsonAsync<APIResponseModel<ElectricUsingModel>>
                ("ElectricUsings", JsonConvert.SerializeObject(model));

            if (rp.ResponseCode == Enums.RESPONSE_CODE_VALID && rp.Result != null)
            {
                rp.Result.ElectricUsingIDHash = Helper.Encrypt(rp.Result.ElectricUsingID);
            }
        ...
        [HttpPatch]
        public async Task<JsonResult> UpdateElectricUsing(ElectricUsingModel model)
        {
            //model.ElectricUsingID = Helper.Decrypt(model.ElectricUsingID);
            //var result = await ApiClient.PatchJsonAsync<APIResponseModel<ElectricUsingModel>>
        ...
        /// <returns></returns>
        [HttpGet]
        public async Task<ActionResult> AccountLogList(jQueryDataTableParamModel Params, string ElectricUsingIDHash)
        {
            var response = await ApiClient.GetJsonAsync<APIResponseListModel<LogChangeModel>>
                ("merchant/BusinessLocationLogList?ElectricUsing=" + Helper.Decrypt(ElectricUsingIDHash) + "&" + Helper.GetQueryString(Params));
        ...
        /// <returns></returns>
        [HttpPatch]
        public async Task<JsonResult> ElectricUsingStatus(Models.Merchants.Account.MerchantAcctStatusModel model)
        {
        ...
        public async Task<ActionResult> TerminalList(jQueryDataTableParamModel Params, string ElectricUsingIDHash)
        {
            ...
            var response = await ApiClient.GetJsonAsync<APIResponseListModel<TerminalModel>>
                ("merchant/TerminalInventoryList?" + Helper.GetQueryString(Params) + "&ElectricUsingNo=" + Helper.Decrypt(ElectricUsingIDHash));
        ...
        //{
        //    // Call API to update 
        //    model.ElectricUsing = Helper.Decrypt(model.ElectricUsingIDHash);
        //    //model.ElectricUsingNo = model.ElectricUsing;// will be removed soon
        ...
        public async Task<ActionResult> GetTxnByBusinessLocation(jQueryDataTableParamModel Params, TxnPointSearchModel txnSearch)
        {
            if (txnSearch != null)
            {
                //txnSearch.ElectricUsing = Helper.Decrypt(txnSearch.ElectricUsingIDHash);
            }
        ...
        //{
        //    model.ElectricUsingNo = Helper.Decrypt(model.ElectricUsingIDHash);
        //    // Call API to update 
