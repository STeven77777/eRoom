...
{
    //WaterUsingsController
    public class WaterUsingsController : Controller
    {
        // GET: Cards
        ...
        public ActionResult Tmpl(string Prefix)
        {
            switch (Prefix)
            {
                case "WaterUsingSearch":
                    return PartialView("List", new WaterUsingModel());
                case "WaterUsingInfoNew":
                    return PartialView("New", new WaterUsingModel());
                case "WaterUsingInfo":
                    return PartialView("Info", new WaterUsingModel());
                default:
                    return PartialView();
            }
        }
        ...
        public async Task<JsonResult> FillData(string Prefix, string WaterUsingIDHash, string WaterUsingAddressId, string WaterUsingContactId, string TerminalIds)
        {
            switch (Prefix)
            {
                case "WaterUsingSearch":
                    {
                        var _infoObj = new WaterUsingModel();

                        var _States = await Common.GetState(null);
                        var _infoSelects = new WaterUsingModel()
                        {
                            //States = _States,
                            //DBAStates = _States
                        };

                        return Json(new FormResponseModel<WaterUsingModel, WaterUsingModel>()
                        {
                ...
                case "WaterUsingInfoNew":
                    {
                        var _newObj = new WaterUsingModel()
                        {

                        };
                        var _newSelects = new WaterUsingModel()
                        {
                ...
                case "WaterUsingInfo":
                    {
                        var _infoObj = await ApiClient.GetJsonAsync<APIResponseModel<WaterUsingModel>>
                            ("waterUsings/" + Helper.Decrypt(WaterUsingIDHash));

                        if (_infoObj != null && _infoObj.Result != null)
                        {
                            _infoObj.Result.WaterUsingIDHash = WaterUsingIDHash;
                        }
                ...
                case "WaterUsingAddrs":
                    {
                        //var _info = await ApiClient.GetJsonAsync<APIResponseModel<WaterUsingModel>>
                        //    ("merchant/BusinessLocation?" + Helper.GetQueryString(new { WaterUsing = Helper.Decrypt(WaterUsingIDHash) }));
                        //var _info = await ApiClient.GetJsonAsync<APIResponseModel<WaterUsingModel>>("WaterUsings/" + Helper.GetQueryString(new { WaterUsingNumber = Helper.Decrypt(WaterUsingIDHash) }));
                        var _info = await ApiClient.GetJsonAsync<APIResponseModel<WaterUsingModel>>("WaterUsings/" + Helper.Decrypt(WaterUsingIDHash));
                        //var _info = await ApiClient.GetJsonAsync<APIResponseListModel<WaterUsingModel>>("WaterUsings/GetList");
                        //var _info = await ApiClient.GetArrayJsonAsync<APIResponseModel<List<WaterUsingModel>>>("WaterUsings/GetList");

                        if (_info != null && _info.Result != null)
                        {
                            // _info.Result.WaterUsingID = Helper.Encrypt(_info.Result.WaterUsingID);
                            return Json(new FormResponseModel<WaterUsingModel, WaterUsingModel>()
                            {
                ...
                case "WaterUsingAddrNew":
                    {
                        ...
                        {
                            //_info.Result.WaterUsingIDHash = Helper.Encrypt(_info.Result.WaterUsingID);
                            ...
                            return Json(new FormResponseModel<AddressModel, WaterUsingModel>()
                            {
                                ResponseCode = Enums.RESPONSE_CODE_VALID,
                                ResponseDesc = "",
                                Model = _newAddress,
                ...
                //        if (_info != null && _info.Result != null && _info.ResponseCode == Enums.RESPONSE_CODE_VALID)
                //        {
                //            //_info.Result.WaterUsingIDHash = Helper.Encrypt(_info.Result.AcctNo);

                //            var addrObj = await ApiClient.GetJsonAsync<APIResponseModel<AddressModel>>
                //                ("common/Address?" + Helper.GetQueryString(new { Ids = WaterUsingAddressId }));
                ...
                //        if (_info != null && _info.Result != null)
                //        {
                //            _info.Result.WaterUsingIDHash = Helper.Encrypt(_info.Result.WaterUsing);
                //            return Json(new FormResponseModel<WaterUsingModel, WaterUsingModel>()
                //            {
                //                ResponseCode = _info.ResponseCode,
                //                ResponseDesc = _info.ResponseDesc,
                ...
                //            return Json(new FormResponseModel<ContactModel, WaterUsingModel>()
                //            {
                //                ResponseCode = Enums.RESPONSE_CODE_VALID,
                //                ResponseDesc = "",
                //                Model = _Obj,
                ...
                //                ("common/ContactById?" + Helper.GetQueryString(new { Ids = WaterUsingContactId }));
                ...
                //            {
                //                WaterUsingIDHash = _info.Result.WaterUsingIDHash
                //            };
                ...
                //            return Json(new FormResponseModel<TerminalModel, WaterUsingModel>()
                //            {
                //                ResponseCode = Enums.RESPONSE_CODE_VALID,
                //                ResponseDesc = "",
                //                Model = _Obj,
                ...
                //            if (_Obj.ResponseCode == Enums.RESPONSE_CODE_VALID)
                //            {
                //                if (_Obj.Result != null && _info.Result != null && _Obj.Result.WaterUsing == _info.Result.WaterUsing) // valid merchant and address
                //                {
                ...
                //            {
                //                //WaterUsingNos = await Common.GetBusinessLocations(),
                //            };

                //            return Json(new FormResponseModel<TxnPointSearchModel, WaterUsingModel>()
                //            {
                //                ResponseCode = Enums.RESPONSE_CODE_VALID,
                //                Model = _Obj,
                //                Selects = _Selects,
                ...
                //case "WaterUsingCrdRangeAccpt":
                //    {
                //        var WaterUsingNo = Helper.Decrypt(WaterUsingIDHash);
                //        var _info = await ApiClient.GetJsonAsync<APIResponseModel<WaterUsingModel>>
                //            ("merchant/BusinessLocation?" + Helper.GetQueryString(new { WaterUsing = WaterUsingNo }));
                ...
                //                ("merchant/CardRangeList?WaterUsingNo=" + WaterUsingNo + "&" + Helper.GetQueryString(_params));
                ...
                //            return Json(new FormResponseModel<CardRangeAcceptanceListModel, WaterUsingModel>()
                //            {
                //                ResponseCode = Enums.RESPONSE_CODE_VALID,
                //                Model = _Obj,
                //                Selects = _Selects,
        ...
        public async Task<ActionResult> WaterUsingSearch(jQueryDataTableParamModel Params, WaterUsingModel model)
        {
            var displyColumns = new string[] { "WaterUsingID", "FullName", "JobName", "HomeTown", "Birthday", "Phone", "Description" };
            ...
            var response = await ApiClient.GetJsonAsync<APIResponseListModel<WaterUsingModel>>
                ("waterUsings/waterUsinglist?" + Helper.GetQueryString(Params) + "&" + Helper.GetQueryString(model));

            if (response == null || response.ResponseCode != 0 || response.Result == null || response.Result.RecordList == null) // empty data/ error
            {
                response.Result.RecordList = new List<WaterUsingModel>();
            }
            ...
            return Json(new
            {
                ...
                aaData = response.Result.RecordList.Select((x, index) => new object[] { Params.iDisplayStart + index + 1, x.WaterUsingID, x.RoomID, x.WaterFrom, 
                    x.WaterTo, x.WaterUse, x.CreateDate != null ? x.CreateDate.Value.ToString(Enums.DATE_FORMAT) : string.Empty, x.Description, Helpers.Helper.Encrypt(x.WaterUsingID) })
            }, JsonRequestBehavior.AllowGet);
        }
        #endregion
        ...
        [HttpPost]
        public async Task<JsonResult> AddWaterUsing(WaterUsingModel model)
        {
            //    model.AllCardRange = model.AllCardRange ?? false;
            //    model.AllTxnCodeMapping = model.AllTxnCodeMapping ?? false;

            // Call API to update 
            var rp = await ApiClient.PostJsonAsync<APIResponseModel<WaterUsingModel>>
                ("WaterUsings", JsonConvert.SerializeObject(model));

            if (rp.ResponseCode == Enums.RESPONSE_CODE_VALID && rp.Result != null)
            {
                rp.Result.WaterUsingIDHash = Helper.Encrypt(rp.Result.WaterUsingID);
            }
        ...
        [HttpPatch]
        public async Task<JsonResult> UpdateWaterUsing(WaterUsingModel model)
        {
            //model.WaterUsingID = Helper.Decrypt(model.WaterUsingID);
            //var result = await ApiClient.PatchJsonAsync<APIResponseModel<WaterUsingModel>>
        ...
        /// <returns></returns>
        [HttpGet]
        public async Task<ActionResult> AccountLogList(jQueryDataTableParamModel Params, string WaterUsingIDHash)
        {
            var response = await ApiClient.GetJsonAsync<APIResponseListModel<LogChangeModel>>
                ("merchant/BusinessLocationLogList?WaterUsing=" + Helper.Decrypt(WaterUsingIDHash) + "&" + Helper.GetQueryString(Params));
        ...
        /// <returns></returns>
        [HttpPatch]
        public async Task<JsonResult> WaterUsingStatus(Models.Merchants.Account.MerchantAcctStatusModel model)
        {
        ...
        public async Task<ActionResult> TerminalList(jQueryDataTableParamModel Params, string WaterUsingIDHash)
        {
            ...
            var response = await ApiClient.GetJsonAsync<APIResponseListModel<TerminalModel>>
                ("merchant/TerminalInventoryList?" + Helper.GetQueryString(Params) + "&WaterUsingNo=" + Helper.Decrypt(WaterUsingIDHash));
        ...
        //{
        //    // Call API to update 
        //    model.WaterUsing = Helper.Decrypt(model.WaterUsingIDHash);
        //    //model.WaterUsingNo = model.WaterUsing;// will be removed soon
        ...
        public async Task<ActionResult> GetTxnByBusinessLocation(jQueryDataTableParamModel Params, TxnPointSearchModel txnSearch)
        {
            if (txnSearch != null)
            {
                //txnSearch.WaterUsing = Helper.Decrypt(txnSearch.WaterUsingIDHash);
            }
        ...
        //{
        //    model.WaterUsingNo = Helper.Decrypt(model.WaterUsingIDHash);
        //    // Call API to update 
