...
namespace MetroOil.LoyaltyOps.Controllers
{
    ...
    public class PeoplesController : Controller
    {
        ...
        public ActionResult Tmpl(string Prefix)
        {
            ...
            {
                case "PeopleSearch":
                    return PartialView("Partials/List", new PeopleModel());
                case "PeopleInfoNew":
                    return PartialView("Partials/New", new PeopleModel());
                case "PeopleInfo":
                    return PartialView("Partials/Profile/Info", new PeopleModel());

                case "PeopleAddrs":
                    return PartialView("Partials/People/PeopleList");
                case "PeopleAddrNew":
        ...
        public async Task<JsonResult> FillData(string Prefix, string PeopleIDHash, string PeopleAddressId, string PeopleContactId, string TerminalIds)
        {
            switch (Prefix)
            {
                case "PeopleSearch":
                    {
                        var _infoObj = new PeopleModel();

                        var _States = await Common.GetState(null);
                        var _infoSelects = new PeopleModel()
                        {
                            //States = _States,
                            //DBAStates = _States
                        };

                        return Json(new FormResponseModel<PeopleModel, PeopleModel>()
                        {
                ...
                case "PeopleInfoNew":
                    {
                        var _newObj = new PeopleModel()
                        {

                        };
                        var _newSelects = new PeopleModel()
                        {
                ...
                case "PeopleInfo":
                    {
                        var _infoObj = await ApiClient.GetJsonAsync<APIResponseModel<PeopleModel>>
                            ("peoples/" + Helper.Decrypt(PeopleIDHash));

                        if (_infoObj != null && _infoObj.Result != null)
                        {
                            _infoObj.Result.PeopleIDHash = PeopleIDHash;
                        }
                ...
                case "PeopleAddrs":
                    {
                        //var _info = await ApiClient.GetJsonAsync<APIResponseModel<PeopleModel>>
                        //    ("merchant/BusinessLocation?" + Helper.GetQueryString(new { People = Helper.Decrypt(PeopleIDHash) }));
                        //var _info = await ApiClient.GetJsonAsync<APIResponseModel<PeopleModel>>("Peoples/" + Helper.GetQueryString(new { PeopleNumber = Helper.Decrypt(PeopleIDHash) }));
                        var _info = await ApiClient.GetJsonAsync<APIResponseModel<PeopleModel>>("Peoples/" + Helper.Decrypt(PeopleIDHash));
                        //var _info = await ApiClient.GetJsonAsync<APIResponseListModel<PeopleModel>>("Peoples/GetList");
                        //var _info = await ApiClient.GetArrayJsonAsync<APIResponseModel<List<PeopleModel>>>("Peoples/GetList");

                        if (_info != null && _info.Result != null)
                        {
                            // _info.Result.PeopleID = Helper.Encrypt(_info.Result.PeopleID);
                            return Json(new FormResponseModel<PeopleModel, PeopleModel>()
                            {
                ...
                case "PeopleAddrNew":
                    {
                        ...
                        {
                            //_info.Result.PeopleIDHash = Helper.Encrypt(_info.Result.PeopleID);
                            ...
                            return Json(new FormResponseModel<AddressModel, PeopleModel>()
                            {
                                ResponseCode = Enums.RESPONSE_CODE_VALID,
                                ResponseDesc = "",
                                Model = _newAddress,
                ...
                //        if (_info != null && _info.Result != null && _info.ResponseCode == Enums.RESPONSE_CODE_VALID)
                //        {
                //            //_info.Result.PeopleIDHash = Helper.Encrypt(_info.Result.AcctNo);

                //            var addrObj = await ApiClient.GetJsonAsync<APIResponseModel<AddressModel>>
                //                ("common/Address?" + Helper.GetQueryString(new { Ids = PeopleAddressId }));
                ...
                //        if (_info != null && _info.Result != null)
                //        {
                //            _info.Result.PeopleIDHash = Helper.Encrypt(_info.Result.People);
                //            return Json(new FormResponseModel<PeopleModel, PeopleModel>()
                //            {
                //                ResponseCode = _info.ResponseCode,
                //                ResponseDesc = _info.ResponseDesc,
                ...
                //            return Json(new FormResponseModel<ContactModel, PeopleModel>()
                //            {
                //                ResponseCode = Enums.RESPONSE_CODE_VALID,
                //                ResponseDesc = "",
                //                Model = _Obj,
                ...
                //                ("common/ContactById?" + Helper.GetQueryString(new { Ids = PeopleContactId }));
                ...
                //            {
                //                PeopleIDHash = _info.Result.PeopleIDHash
                //            };
                ...
                //            return Json(new FormResponseModel<TerminalModel, PeopleModel>()
                //            {
                //                ResponseCode = Enums.RESPONSE_CODE_VALID,
                //                ResponseDesc = "",
                //                Model = _Obj,
                ...
                //            if (_Obj.ResponseCode == Enums.RESPONSE_CODE_VALID)
                //            {
                //                if (_Obj.Result != null && _info.Result != null && _Obj.Result.People == _info.Result.People) // valid merchant and address
                //                {
                ...
                //            {
                //                //PeopleNos = await Common.GetBusinessLocations(),
                //            };

                //            return Json(new FormResponseModel<TxnPointSearchModel, PeopleModel>()
                //            {
                //                ResponseCode = Enums.RESPONSE_CODE_VALID,
                //                Model = _Obj,
                //                Selects = _Selects,
                ...
                //case "PeopleCrdRangeAccpt":
                //    {
                //        var PeopleNo = Helper.Decrypt(PeopleIDHash);
                //        var _info = await ApiClient.GetJsonAsync<APIResponseModel<PeopleModel>>
                //            ("merchant/BusinessLocation?" + Helper.GetQueryString(new { People = PeopleNo }));
                ...
                //                ("merchant/CardRangeList?PeopleNo=" + PeopleNo + "&" + Helper.GetQueryString(_params));
                ...
                //            return Json(new FormResponseModel<CardRangeAcceptanceListModel, PeopleModel>()
                //            {
                //                ResponseCode = Enums.RESPONSE_CODE_VALID,
                //                Model = _Obj,
                //                Selects = _Selects,
        ...
        public async Task<ActionResult> PeopleSearch(jQueryDataTableParamModel Params, PeopleModel model)
        {
            var displyColumns = new string[] { "PeopleID", "FullName", "JobName", "HomeTown", "Birthday", "Phone", "Description" };
            ...
            var response = await ApiClient.GetJsonAsync<APIResponseListModel<PeopleModel>>
                ("peoples/peoplelist?" + Helper.GetQueryString(Params) + "&" + Helper.GetQueryString(model));

            if (response == null || response.ResponseCode != 0 || response.Result == null || response.Result.RecordList == null) // empty data/ error
            {
                response.Result.RecordList = new List<PeopleModel>();
            }
            ...
            return Json(new
            {
                ...
                aaData = response.Result.RecordList.Select((x, index) => new object[] { Params.iDisplayStart + index + 1, x.PeopleID, x.FullName, x.JobName, 
                    x.HomeTown, x.Birthday != null ? x.Birthday.Value.ToString(Enums.DATE_FORMAT) : string.Empty, x.Phone, x.Description, Helpers.Helper.Encrypt(x.PeopleID) })
            }, JsonRequestBehavior.AllowGet);
        }
        #endregion
        ...
        [HttpPost]
        public async Task<JsonResult> AddPeople(PeopleModel model)
        {
            //    model.AllCardRange = model.AllCardRange ?? false;
            //    model.AllTxnCodeMapping = model.AllTxnCodeMapping ?? false;

            // Call API to update 
            var rp = await ApiClient.PostJsonAsync<APIResponseModel<PeopleModel>>
                ("Peoples", JsonConvert.SerializeObject(model));

            if (rp.ResponseCode == Enums.RESPONSE_CODE_VALID && rp.Result != null)
            {
                rp.Result.PeopleIDHash = Helper.Encrypt(rp.Result.PeopleID);
            }
        ...
        [HttpPatch]
        public async Task<JsonResult> UpdatePeople(PeopleModel model)
        {
            //model.PeopleID = Helper.Decrypt(model.PeopleID);
            //var result = await ApiClient.PatchJsonAsync<APIResponseModel<PeopleModel>>
        ...
        /// <returns></returns>
        [HttpGet]
        public async Task<ActionResult> AccountLogList(jQueryDataTableParamModel Params, string PeopleIDHash)
        {
            var response = await ApiClient.GetJsonAsync<APIResponseListModel<LogChangeModel>>
                ("merchant/BusinessLocationLogList?People=" + Helper.Decrypt(PeopleIDHash) + "&" + Helper.GetQueryString(Params));
        ...
        /// <returns></returns>
        [HttpPatch]
        public async Task<JsonResult> PeopleStatus(Models.Merchants.Account.MerchantAcctStatusModel model)
        {
        ...
        public async Task<ActionResult> TerminalList(jQueryDataTableParamModel Params, string PeopleIDHash)
        {
            ...
            var response = await ApiClient.GetJsonAsync<APIResponseListModel<TerminalModel>>
                ("merchant/TerminalInventoryList?" + Helper.GetQueryString(Params) + "&PeopleNo=" + Helper.Decrypt(PeopleIDHash));
        ...
        //{
        //    // Call API to update 
        //    model.People = Helper.Decrypt(model.PeopleIDHash);
        //    //model.PeopleNo = model.People;// will be removed soon
        ...
        public async Task<ActionResult> GetTxnByBusinessLocation(jQueryDataTableParamModel Params, TxnPointSearchModel txnSearch)
        {
            if (txnSearch != null)
            {
                //txnSearch.People = Helper.Decrypt(txnSearch.PeopleIDHash);
            }
        ...
        //{
        //    model.PeopleNo = Helper.Decrypt(model.PeopleIDHash);
        //    // Call API to update 
